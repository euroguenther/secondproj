========================================================================
    KONSOLENANWENDUNG: zweitesProjekt-Projektübersicht
========================================================================

Diese zweitesProjekt-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre zweitesProjekt-Anwendung besteht.


zweitesProjekt.vcxproj
...
zweitesProjekt.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen zweitesProjekt.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
